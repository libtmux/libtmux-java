 ...
 * the pump included, and nothing inside it ever asks the pump to stop. This is not hypothetical: an
 * earlier revision of these tests hung this suite for that exact reason, caught only by the process
 * still running long after every other test had finished.
 */
