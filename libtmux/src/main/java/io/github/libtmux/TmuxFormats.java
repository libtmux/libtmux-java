...
public final class TmuxFormats {
     ...
     *
     * <p>Measured on every release in the matrix: tmux doubles each backslash; 3.2a through 3.4 put a
     * backslash before a {@code $} that a letter, {@code _}, or <code>{</code> follows; 3.2a through
     * 3.6 store {@code .} and {@code :} as {@code _} and a control character as a C escape or three
