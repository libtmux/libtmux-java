 ...
 *
 * <p>{@code QuotingPropertyIntegrationTest} checks the same text against every release in the
 * matrix; this pins the boundaries, so a rule that starts or stops a release early fails here with
 * the release named.
 */
