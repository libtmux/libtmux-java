...
```text
runtimeClasspath
+--- io.github.libtmux:libtmux-bom:0.0.1-alpha.9
|    \--- io.github.libtmux:libtmux:0.0.1-alpha.9 (c)
\--- io.github.libtmux:libtmux -> 0.0.1-alpha.9
```

The `-> 0.0.1-alpha.9` on a coordinate you wrote without a version is the platform
doing its job.
