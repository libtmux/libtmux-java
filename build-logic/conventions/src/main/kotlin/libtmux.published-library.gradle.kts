...
//
// libtmux.sbom is not on the shared publication convention: libtmux-bom applies that one too, and a
// `java-platform` has no runtimeClasspath to describe — its SBOM would be an empty document that
