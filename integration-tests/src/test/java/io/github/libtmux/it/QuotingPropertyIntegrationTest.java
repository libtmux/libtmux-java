 ...
 * parses back into words. Each seeded value is written to a user option and read back, so a value
 * that loses or gains a character on the way in fails with the value named. Control characters are
